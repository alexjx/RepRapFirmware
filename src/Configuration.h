...
constexpr unsigned int FirstHdc1080TemperatureChannel = 600;	// Temperature sensor channels 600... are HDC1080 sensors
constexpr unsigned int FirstHdc1080HumidityChannel = 650;	// Temperature sensor channels 600... are HDC1080 sensors
